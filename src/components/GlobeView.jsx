        ...
        if (window.Hands && window.Camera) {
          ...
          hands.onResults((results) => {
            ...
            if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
              ...
              p.targetScale = THREE.MathUtils.clamp(
                THREE.MathUtils.mapLinear(distSum / 5, 0.1, 0.5, 0.5, 2.0),
                0.4,
                2.5
              )
              ...
              // 回転
              const dirX = middleBase.x - wrist.x,
                dirY = middleBase.y - wrist.y
  ...
  useEffect(() => {
    ...
    globe
      ...
      .polygonLabel(({ properties }) => {
        ...
        const jpName = matched?.translations?.ja?.common ?? matched?.name.common ?? properties.ADMIN
      ...
      .labelText((country) => country.translations?.ja?.common ?? country.name.common)
